    ...
    return (
        <footer className="bg-dark-alternate text-white mt-52 md:px-20">
            <div className="container mx-auto flex justify-between pt-14 pb-24">
                ...
                <p className="mt-8"> Engineered for endurance and designed for speed.  Experience gear that moves as fast as you do.
                </p>
                </div>

                <div className="w-105 grid grid-cols-2">
                    {/* bungkus div lagi biar tulisannya ke bawah, flex col & gap 7 itu jarak ke bawahnya 30 */}
